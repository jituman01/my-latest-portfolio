        ...
        <div className="flex flex-col lg:block min-h-screen">
            ...
            <div className="flex justify-center lg:justify-start items-center gap-2 text-gray-400 text-sm md:text-base mt-5">
              ...
              <div className="relative h-[30px] overflow-hidden w-[180px] md:w-[220px]">
                {words.map((word, i) => (
                  <span
                    key={i}
                    className={`absolute inset-0 font-bold text-violet-500 transition-all duration-500 ${
                      i === index
          ...
          >
            ...
            <div className='lg:mt-80'>
              ...
              <span className="block text-violet-500 text-2xl md:text-3xl lg:text-4xl font-black">
                FULL STACK
              </span>
...
const SocialIcon = ({ icon, href }) => (
  <a
    ...
    className="w-12 h-12 flex items-center justify-center rounded-full bg-white/10 backdrop-blur-md border border-white/10 hover:bg-violet-500 transition-all duration-300 hover:scale-110"
  >
    {icon}
  </a>
);
